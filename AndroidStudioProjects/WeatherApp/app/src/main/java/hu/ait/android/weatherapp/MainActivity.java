...
import hu.ait.android.weatherapp.fragments.AddCityFragment;

public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, AddCityFragment.AddCityListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CityRecyclerAdapter(citiesList, this);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.add_city) {
            ...
            Toast.makeText(MainActivity.this, "Created by Emily Old. November 2015.", Toast.LENGTH_SHORT).show();
        }
    ...
    public void onDialogAdd(DialogFragment dialog) {
        ...
        EditText etCityName = (EditText) dialogView.findViewById(R.id.etNewCity);

        City newCity = new City(etCityName.getText().toString());
    ...
    protected void showDialogFragment(){
        ...
        addCityFragment.show(getSupportFragmentManager(), addCityFragment.TAG);
    }
}
